...
class ExternalSection:
    ...
    def __init__(self, data: dict[str, Any]) -> None:
        ...
        self.okapi_url = data.get("okapi_url", "http://127.0.0.1:4835")
...
class DatabaseSection:
    ...
    def __init__(self, data: dict[str, Any]) -> None:
        self.postgres_name = data.get("postgres_name", "fablerpg")
        self.postgres_user = data.get("postgres_user", "postgres")
        self.postgres_port = data.get("postgres_port", 0)
        self.postgres_host = data.get("postgres_host", "localhost")
        self.postgres_password = data.get("postgres_password", "")
        self.redis_host = data.get("redis_host", "127.0.0.1")
        self.redis_port = data.get("redis_port", 0)
